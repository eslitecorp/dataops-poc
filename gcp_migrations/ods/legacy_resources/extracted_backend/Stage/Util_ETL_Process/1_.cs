...
namespace ST_fa63f52061d144388042db205dee6fba
{
    ...
    public partial class ScriptMain : Microsoft.SqlServer.Dts.Tasks.ScriptTask.VSTARTScriptObjectModelBase
    {
        ...
        public void Main()
        {
            ...
            String rawDataFilePatternStr = Dts.Variables["$Package::param_fileNamePattern"].Value.ToString();
            string fileName = Dts.Variables["$Package::srcRawDataFileName"].Value.ToString();
            if (fileName.ToUpper().Contains(".ZIP") || fileName.ToUpper().Contains(".7Z") || fileName.ToUpper().Contains(".RAR"))
            {
